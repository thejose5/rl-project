...
def gen_curriculum_baseline(gen_digits):
    ...
    #[[1/max_enemies, 1/max_enemies, 1/max_enemies...]]
...
def gen_curriculum_naive(gen_digits):
    ...
    #[[1,0,0,0,..max_enemies times],[0,1,0,0,0...],[0,0,1,0,0...],... max_enemies times] + [1/max_enemies, 1/max_enemies, 1/max_enemies...]


def gen_curriculum_mixed(gen_digits):
    return [[1/(i+1) if j <= i else 0 for j in range(gen_digits)] for i in range(gen_digits)]
    #[[1,0,0,0...],[1/2,1/2,0,0,...],[1/3,1/3,1/3,....],...]
...
def gen_curriculum_combined(gen_digits):
    ...
    # [[1,0,0,...],[1/4,3/4,0,0,...],[1/6,1/6,4/6,0,0,...],...] + [1/max_enemies, 1/max_enemies, 1/max_enemies...]
